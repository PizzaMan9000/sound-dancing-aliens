function startClassification() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/y3DyeVhR-/model.json', modelReady);
}
...
function gotResults(error, results) {
    if (error) {
        ...
        document.getElementById("resultConfidence").style.color = "rgb(" + random_color_r + "," + random_color_g + "," + random_color_b + ")";
